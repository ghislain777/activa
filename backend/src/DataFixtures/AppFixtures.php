...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $aprivileges = new Activite();
        $aprivileges->setNom('Privilèges')->setDescription('Privilèges')->setChemain("/administration/privileges")->setMenu($administration);
        $manager->persist($aprivileges);
        $manager->flush();


        $aconfiguration = new Activite();
        $aconfiguration->setNom('Configuration')->setDescription('Paramètres de configuration')->setChemain("/parametres/configuration")->setMenu($parametres);
        $manager->persist($aconfiguration);
        $manager->flush();
