...
// on trie les privileges par position d'activité
            ...
            $navigation = array();
            $listeMenus = $menuRepository->findBy([], ["position" => "asc"]);
            ...
            foreach ($listeMenus as $menu) {
                ...
                $lemenu["position"] = $menu->getPosition();
                $lemenu["children"] = [];
                ...
                foreach ($listePrivileges as $privilege) {
                    if ($privilege->getActivite()->getMenu()->getId() == $lemenu["id"]) {
                        array_push($lemenu["children"], [
                            ...
                            "position" => $privilege->getActivite()->getPosition(),
                        ]);
                    }
                }
